...
class Add_Note_Screen_Insides_Folder extends StatefulWidget {
  ...
  const Add_Note_Screen_Insides_Folder(this.folderId, {super.key});

  @override
  State<Add_Note_Screen_Insides_Folder> createState() =>
      _Add_Note_Screen_Insides_FolderState();
}
        ...
        ElevatedButton(
          ...
          onPressed: () async {
            ...
            Firestore_Datasource().AddNoteToFolder(
                widget.folderId, subtitleContent, title.text, indexx);
